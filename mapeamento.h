...
//Criando o tipo Funcao, uma fun��o que recebe uma string e n�o retorna nada.
typedef void (*Funcao)(char*);

//Estrutura para armazenar comandos como uma lista(Sim n�o existe listas em C...)

struct pos_comandos{
    struct pos_comandos * prox; //Ponteiro para o pr�ximo
    char *comando; //Texto que representa o comando
    Funcao f; //Fun��o a ser executada pelo comando
};
...
//Fun��o que recebe uma lista de comandos e um texto e apartir do texto
...
//fun��o que adiciona um novo comando a lista de comandos
...
//    N�o podemos passar a string atravez de =, temos que copiar
...
//    interando lista at� o final dela
    Posicao aux = cabeca;
    while(aux->prox != NULL)
        aux = aux->prox;
    aux->prox = p;
...
//Fun��o para transformar int em string, ignore e use sprintf, printf em string.
